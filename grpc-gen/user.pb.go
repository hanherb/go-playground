...
func (x *UserGetOneResponse) GetData() *User {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_protobuf_user_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
...
var file_protobuf_user_proto_depIdxs = []int32{
	0, // 0: playground.v1.UserGetOneResponse.data:type_name -> playground.v1.User
